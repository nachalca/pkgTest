...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_rIW");
    reader.add_event(11, 11, "end", "model_rIW");
    return reader;
}

#include <meta_header.hpp>
 class model_rIW : public prob_grad {
private:
    int k;
    int d;
    matrix_d R;
public:
    model_rIW(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_rIW_namespace::model_rIW";
        ...
        try {
            ...
            current_statement_begin__ = 4;
            check_greater_or_equal(function__,"d",d,k);
            current_statement_begin__ = 5;
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "model_rIW_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            stan::math::assign(Sigma, inv_wishart_rng(d,R, base_rng__));
...
typedef model_rIW_namespace::model_rIW stan_model;
